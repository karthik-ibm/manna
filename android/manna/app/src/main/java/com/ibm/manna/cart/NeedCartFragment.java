...
public class NeedCartFragment extends Fragment implements View.OnClickListener {
    View view;
    Button button;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_need_cart, container, false);

        Toolbar toolbar = (Toolbar) view.findViewById(R.id.needitemToolbar);
        ...
        /*if(cart.getCatalogItemsArrayList()!=null){
            ...
            {
//                requestItemsArrayList.add(new RequestItems(cart.getCatalogItemsArrayList().get(i).getCatalog().getDescr(),cart.getCatalogItemsArrayList().get(i).getCatalog().getDescr(),cart.getCatalogItemsArrayList().get(i).getItems(),cart.getCatalogItemsArrayList().get(i).getItems(),(int) cart.getCatalogItemsArrayList().get(i).getQuantity(),"kg",cart.getCatalogItemsArrayList().get(i).getImage()));
            }
        }*/

        button =view.findViewById(R.id.tapneedButton);
        cartTotal = view.findViewById(R.id.need_cart_quantity);
        recyclerviewTotal = view.findViewById(R.id.need_total);
        address1 = view.findViewById(R.id.need_address_line1);
        address2 = view.findViewById(R.id.need_address_line2);
        address3 = view.findViewById(R.id.need_address_line3);
        address4 = view.findViewById(R.id.need_address_line4);
        locationText= view.findViewById(R.id.marklocation_need);
        location = view.findViewById(R.id.location_need);
        recyclerView = view.findViewById(R.id.need_cart_list);
        time = view.findViewById(R.id.selecttime_need);
        ...
        address1.setText(userProfile.getAddress().getLine1());
        address2.setText(userProfile.getAddress().getLine1());
        address3.setText(userProfile.getAddress().getCity());
        address4.setText(userProfile.getAddress().getState()+" -"+userProfile.getAddress().getPin());
        ...
        catalogItemAdapter = new CartItemAdapter(getContext(),cart.getRequests().getReqItems(), new CartItemAdapter.DetailsAdapterListener() {
            ...
            public void addOnClick(View v, int position) {
                ...
                System.out.println("item "+cart.getRequests().getReqItems().get(position).getItem_descr());
                addItems(cart.getRequests().getReqItems(), position);
            }

            @Override
            public void subOnClick(View v, int position) {
                removeItems(cart.getRequests().getReqItems(), position);
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.location_need:
                break;
            case R.id.marklocation_need:
                ...
                break;
            case R.id.selecttime_need:
                TimePicker();
                break;
            case R.id.tapneedButton:
                submitRequest();
...
/*        requests.setReqCat(cart.getRequestItemsArrayList().get(0).getCat_descr());
    ...
    public void submitDialog()
    {
        ...
        line1.setText(R.string.need_sub_title);
        line2.setText(R.string.need_sub_msg);
